...
mentor issues:
1. Пакеты .mvn/wrapper .idea и target не должны попадать в коммит, добавь в gitignore и удали из коммита
2. Connection можно удалить, он тут не используется
3. Не используй нативные запросы createNativeQuery
4. Транзакции работают не полностью